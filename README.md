...
Start de applicatie: python app.py
...
- Performance kan beter bij grote datasets
- Image request cachen niet waardoor dit elke keer opnieuw moet, waardoor pagina's langzaam laden

# Toekomstige verbeteringen
- Meer dieren feitjes
- Image caching
- Beveiligde admin control panel
- Meer custom images, ik heb nu alleen de zebra die een custom afbeelding heeft.